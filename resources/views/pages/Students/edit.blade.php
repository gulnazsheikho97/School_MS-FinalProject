                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{$Students->getTranslation('student_name','ar')}}" type="text" name="student_name_ar"  class="form-control">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{$Students->getTranslation('student_name','en')}}" class="form-control" name="student_name_en" type="text" >
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="nationalitie_id">
                                        ...
                                        @foreach($nationals as $nal)
                                            <option value="{{ $nal->id }}" {{$nal->id == $Students->nationalitie_id ? 'selected' : ""}}>{{ $nal->Nationalitie_Name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="blood_id">
                                        ...
                                        @foreach($bloods as $bg)
                                            <option value="{{ $bg->id }}" {{$bg->id == $Students->blood_id ? 'selected' : ""}}>{{ $bg->BloodType_Name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="Classroom_id">
                                        ...
                                        @foreach($list_classes as $class)
                                            <option value="{{$Students->Classroom_id }}" {{$class->id== $Students->Classroom_id ? 'selected' : ""}}>{{ $class->name_class }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="section_id">
                                        ...
                                        @foreach($list_sections as $Section)
                                            <option value="{{ $Students->section_id }}" {{$Section->id == $Students->section_id ? 'selected' : ""}}>{{ $Section->section_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
